...
local i=luci.sys.exec("grep address /usr/share/koolproxy/dnsmasq.adblock | wc -l")
...
o = Map("koolproxy", translate("KoolProxy"), translate("高效的，用于修改和过滤流量包的代理工具。修改内容，过滤页面元素，完全控制一切内容。"))
